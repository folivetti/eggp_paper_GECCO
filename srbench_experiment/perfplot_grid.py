...
algs = ["eggp_mo", "eggp_so", "PySR", "Operon", "tinyGP", "symregg"]
...
print("\n====AUC====")
s = tbl_auc[algs].style.highlight_max(axis=1, props="mathbf:--rwrap")
s.format("{:.2f}")
print(s.to_latex())
...
#ranks = tbl_auc.rank(axis=1, ascending=False)
...
s = tbl[algs].style.highlight_max(axis=1, props="mathbf:--rwrap")
print(s.to_latex())
