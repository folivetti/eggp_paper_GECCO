#!/bin/zsh
for DSETF in `ls -d results/eggp/*/`; do
    DSET=${DSETF#results/eggp/}
    for ALG in SymRegg GPGOMEA GPZGD PySIPS_finetuned PySR random Operon eggp QLattice neogp slim_gsgp; do
