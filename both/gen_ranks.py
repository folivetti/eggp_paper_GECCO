...
plt.savefig(f'plots/ranks/diagram_{args.criteria}_{args.agg}{'_pct' if args.pct else ''}{'_'+grid if len(grid) else ''}{'_'+args.ext if len(args.ext) else args.ext}.eps')
