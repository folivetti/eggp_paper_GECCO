...
do for [ds in "chemical_1_tower chemical_2_competition friction_stat_one-hot nasa_battery_1_10min nikuradse_1 nikuradse_2 flow_stress_phip0.1 friction_dyn_one-hot"] {
  set title ds
...
# gen,MSE_train_median,MSE_train_p5,MSE_train_p95,MSE_test_median,MSE_test_p5,MSE_test_p95,nll_train_median,nll_train_p5,nll_train_p95,dl_median,dl_p5,dl_p95,size_median,size_p5,size_p95
   ...
   set ylabel "DL"
   plot 'neogp_nll/'.ds.'/stats.csv' using "gen":"dl_p10":"dl_p90" lc 1 with  filledcurves fs transparent solid 0.3  title "obj NLL",\
        '' using "gen":"dl_median" lc 1 with lines notitle,\
        'neogp_dl/'.ds.'/stats.csv'  using "gen":"dl_p10":"dl_p90" lc 2 with  filledcurves fs transparent solid 0.3  title "obj DL",\
        '' using "gen":"dl_median" lc 2 with lines notitle,\
   
   unset yrange
   set ylabel "Best size"
   set key bottom right
   plot 'neogp_nll/'.ds.'/stats.csv' using "gen":"size_p5":"size_p95" lc 1 with  filledcurves fs transparent solid 0.3  title "obj NLL",\
        '' using "gen":"size_median" lc 1 with lines notitle,\
        'neogp_dl/'.ds.'/stats.csv'  using "gen":"size_p5":"size_p95" lc 2 with  filledcurves fs transparent solid 0.3  title "obj DL",\
