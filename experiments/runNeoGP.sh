...
if [ $2 = "srbench" ]; then
    parallel --bar -S .. -j$NJOBS --return ~/eggp_paper_GECCO/report/results/neogp_nsga2/{3}/run_{2}_{1}.csv \
    ...
    parallel --bar -S .. -j$NJOBS --return ~/eggp_paper_GECCO/report/results/neogp_nsga2/{2}/run_{1}.csv \
        "(cd ~/eggp_paper_GECCO/experiments/; \
